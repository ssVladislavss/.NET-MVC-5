$(function () {
    /*Асинхронный метод добавления новых категорий с использованием ajax*/
    /* Урок 9 */
    ...
    newCatA.click(function (e) {
        ...
        $.post(url, { catName: catName }, function (data) {
            var response = data.trim();//После обработки методом AddNewCategory возвращается какая-то строка

            if (response == "titletaken") {
                ajaxText.html("<span class='alert alert-danger'>That title is taken!</span>");//Выводится сообщение с ошибкой
                setTimeout(function () {
    ...
    $("body").on("click", "a.delete", function () {
        if (!confirm("confirm category delection")) return false;
    });
    ...
    /*скрипт переименовывания категорий*/
